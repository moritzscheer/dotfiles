		...
		keys = {
			{
				"<leader>p",
				function()
					require("utils.command-palette").show_commands()
				end,
			...
			picker = {
				...
				sources = {
					explorer = {
						...
						actions = {
							copy_file_path = {
								action = require("utils.explorer").copy_file_path,
							},
							search_in_directory = {
								action = require("utils.explorer").search_in_directory,
							},
							search_in_directory_case_sensitive = {
								action = require("utils.explorer").search_in_directory_case_sensitive,
							},
							diff = {
								action = require("utils.explorer").diff,
							},
						},
						win = {
							list = {
